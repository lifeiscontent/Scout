  ...
  _createClass(ScoutInfoPanel, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          'details',
          { onClick: this.handleHelpClick, style: { display: '' + (this.state.helpIsActive ? 'block' : 'inline-block') } },
          React.createElement(
            'summary',
        ...
        React.createElement(
          'a',
          { style: this.style.link, href: 'https://hired.com/x/On0PYI', target: '_blank' },
          'Looking for a job?'
        ),
  ...
  _createClass(Scout, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        'div',
        null,
        React.createElement('div', { style: _extends({}, style, {
